...
const data_music = ['1Fwv9oA5Jje4sBE0rcXHiP', '0pKUmPHhQTGUb2JY99bkEX', '0zaVvnZbZm5oAWCOU9UOgJ', '0taluMnYokviw9ujgOslXV', '7tUDcpspJ78Vw7CMbt4a7D', '16LZJJN61lQjFxtvNzhU9d', '02xwA3Ej9NPetftp9V7VZ3', '06fMKL5WAQtTOgGW2CD90H'];
function playAudio() {
  audio.play().then(() => {
  ...
  function changepage() {
    ...
    if (page === 0) {
      ...
      igicon.onload = function() {
        ...
        const igname = '<div class="igname"><p>hoshinoai_1.51</p></div>'
      ...
      const spotify_icon = `<a
             class="spotify_icon" id="spotify_icon" href="https://open.spotify.com/artist/2EqaSEa0WkE59Aca9iXSYj?si=2tJnmIGlRq6Pcv_AYJOLIA"
             target="_blank"></a>`
      ...
      tourGuideImg.onload = function() {
        main.appendChild(tourGuideImg);
        const text_box = `<div class="music_text-box"><div class="text-index"><p>最喜歡『ユイカ』了！<br>真的很期待5/31的演唱會！</p></div></div>`
        setTimeout(function() {
          main.insertAdjacentHTML('beforeend', text_box);
          isPageChanging = false;
